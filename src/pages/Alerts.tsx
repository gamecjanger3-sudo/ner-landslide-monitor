  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          className="relative top-12 flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-700 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors shadow-sm"
          onClick={() => window.location.reload()}
        >
          <RefreshCw size={16} />
          <span>{t('Refresh Risk Data')}</span>
        </button>
      </div>
