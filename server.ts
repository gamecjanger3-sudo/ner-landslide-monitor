...
// Supports:
//
// /api/weather?city=Kanpur
//
// OR
//
// /api/weather?lat=26.4499&lon=80.3319
//
// Browser -> Express -> OpenWeather
// --------------------------------------------------
...
app.get('/api/weather', async (req, res) => {
  try {
    ...
    if (hasCoordinates) {
      ...
      console.log(
        `Fetching weather for user location: ${lat}, ${lon}`,
      );
...
app.post(
  ...
  async (
    ...
    try {
      ...
      console.error(
        'Error handling report submission:',
        error
      )
